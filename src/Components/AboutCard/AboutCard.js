      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Olá a todos! Meu nome é <span className="purple">Marianna Magno</span>.
           ...
           <br />
            <br />
            ⚡ E particularmente venho buscando aprender a lingaguem JS, juntamente com HTML e CSS, focando em desenvolvimento Back End.
